<%@page import="com.flyaway.ticket.model.BookModel"%>
<%@page import="com.flyaway.ticket.util.DataUtility"%>
<%@page import="java.util.Iterator"%>
<%@page import="java.util.List"%>
<%@page import="com.flyaway.ticket.bean.BookBean"%>
<%@page import="com.flyaway.ticket.controller.BookListCtl"%>
...
<%@ include file="Header.jsp"%>
	<form action="<%=FlyawayView.BOOK_LIST_CTL%>" method="post">
		<div class="container">
			<div class="row">
				<center>
