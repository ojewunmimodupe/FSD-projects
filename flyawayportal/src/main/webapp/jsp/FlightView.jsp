<%@page import="com.flyaway.ticket.controller.FlightCtl"%>
		...
		<div id="signupbox" style="margin-top: 50px"
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<form method="post" action="<%=FlyawayView.FLIGHT_CTL%>">
						<jsp:useBean id="bean"
							class="com.flyaway.ticket.bean.FlightBean" scope="request"></jsp:useBean>
