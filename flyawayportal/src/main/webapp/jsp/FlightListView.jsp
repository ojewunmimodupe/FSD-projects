<%@page import="com.flyaway.ticket.model.FlightModel"%>
<%@page import="com.flyaway.ticket.util.DataUtility"%>
<%@page import="java.util.Iterator"%>
<%@page import="java.util.List"%>
<%@page import="com.flyaway.ticket.bean.FlightBean"%>
<%@page import="com.flyaway.ticket.controller.FlightListCtl"%>
<%@page import="com.flyaway.ticket.util.ServletUtility"%>
...
<body>
	...
	<form action="<%=FlyawayView.FLIGHT_LIST_CTL%>" method="post">
		<div class="container">
			<div class="row">
				<center>
					<h3>Flight List</h3>
