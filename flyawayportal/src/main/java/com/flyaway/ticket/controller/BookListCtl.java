...
public class BookListCtl extends BaseCtl {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op) || OP_PREVIOUS.equalsIgnoreCase(op)) {
			...
			ServletUtility.redirect(FlyawayView.BOOK_CTL, request, response);
			return;
			...
			ServletUtility.redirect(FlyawayView.BOOK_LIST_CTL, request, response);
			return;
	...
	protected String getView() {
		...
		return FlyawayView.BOOK_LIST_VIEW;
	}
