package com.flyaway.ticket.controller;
...
import com.flyaway.ticket.bean.BaseBean;
import com.flyaway.ticket.bean.BookBean;
import com.flyaway.ticket.bean.FlightBean;
import com.flyaway.ticket.exception.ApplicationException;
import com.flyaway.ticket.exception.DuplicateRecordException;
import com.flyaway.ticket.model.BookModel;
import com.flyaway.ticket.model.FlightModel;
import com.flyaway.ticket.util.DataUtility;
import com.flyaway.ticket.util.DataValidator;
import com.flyaway.ticket.util.PropertyReader;
import com.flyaway.ticket.util.ServletUtility;
...
public class BookCtl extends BaseCtl {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (OP_PAYMENT.equalsIgnoreCase(op)) {
			...
			ServletUtility.forward(FlyawayView.PAYMENT_VIEW, request, response);
			...
			ServletUtility.redirect(FlyawayView.INDEX_CTL, request, response);
			return;
	} 
