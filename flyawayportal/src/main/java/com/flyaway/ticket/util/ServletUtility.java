package com.flyaway.ticket.util;
...
import com.flyaway.ticket.controller.BaseCtl;

import com.flyaway.ticket.controller.FlyawayView;
...
public class ServletUtility {
	...
	public static void handleException(Exception e, HttpServletRequest request, HttpServletResponse response)
		...
		ServletUtility.forward(FlyawayView.ERROR_CTL, request, response);
		e.printStackTrace();
	}
